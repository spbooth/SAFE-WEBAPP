 ...
 *
 */
public class Pollux extends DataObject implements Removable {
	public static final String NAME = "Name";
	public static final String REMOTE = "Remote";
	public static final String DEFAULT_TABLE = "Pollux";
	
  	 
	public Pollux(Repository.Record res) {
		super(res);
	}

	public Pollux(AppContext ctx) {
	...
	public void setReference(Castor peer) {
		record.setProperty(REMOTE, peer);
	}
	
	
    public static class Factory extends DataObjectFactory<Pollux> {
		...
		protected TableSpecification getDefaultTableSpecification(AppContext c,
			...
			spec.setField(REMOTE, new ReferenceFieldType(Castor.DEFAULT_TABLE));
			return spec;
		}
