 ...
 *
 */
@uk.ac.ed.epcc.webapp.Version("$Id: Log4JWebappContextListener.java,v 1.20 2015/07/01 14:29:50 spb Exp $")
@WebListener()
public class Log4JWebappContextListener extends WebappContextListener {
	...
	public void contextInitialized(ServletContextEvent arg0) {
		...
		conn.close();
			...
			System.out.println("Error starting Log4JWebappContextListener");
			t.printStackTrace();
		}
	}
