...
public interface FieldValue<T,X> extends  SQLAccessor<T,X>, GroupingSQLValue<T>{
	 ...
	 * to map it to the SQL representation of the object (as generated by {@link #addField(StringBuilder, boolean)}
	 ...
	 * Normally the same as {@link #add(StringBuilder, boolean)}
	 * 
	 * @param sb
	 * @param qualify
	 * @return
	 */
    public default int addField(StringBuilder sb, boolean qualify) {
