...
public class Dummy4 extends DataObject {
	...
	public Dummy4(Repository.Record res) {
		super(res);
	}

	public Dummy4(AppContext ctx) {
	...
	public void setRef(Dummy3 peer) {
		record.setProperty(REF, peer.getID());
	}
    public static class Factory extends DataObjectFactory<Dummy4>{
		public class NumberFilter extends SQLValueFilter<Dummy4>{
        	public NumberFilter(Number n){
        		super(Factory.this.getTarget(),res,NUMBER,n);
        	}
        }
        public class StringFilter extends SQLValueFilter<Dummy4>{
		...
		@Override
		protected Dummy4 makeBDO(Repository.Record res) throws DataFault {
			return new Dummy4(res);
		}
		...
		protected TableSpecification getDefaultTableSpecification(AppContext c,
			...
			spec.setField(REF, new ReferenceFieldType(Dummy3.DEFAULT_TABLE));
			return spec;
		}
