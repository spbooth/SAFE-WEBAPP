...
ListInputInterfaceTest<String, TestType.TestValue, BasicTypeInput<TestType.TestValue>, BasicTypeInputTestWithLimit>{
	...
	public Set<String> getBadData() {
		...
		values.add("Sooty");
		values.add("Basil");
		values.add(TestType.BLOB.getTag());
		return values;
	}
	...
	public Set<String> getGoodData()  {
		...
		values.remove(TestType.BLOB.getTag());
		return values;
	}
	...
	public BasicTypeInput<TestValue> getInput() throws Exception {
		BasicTypeInput<TestValue> input = TestType.monsters.getInput();
		Set<TestType.TestValue> set = TestType.monsters.getValueSet();
		set.remove(TestType.BLOB);
		input.setSelectSet(set);
		return input;
	}
