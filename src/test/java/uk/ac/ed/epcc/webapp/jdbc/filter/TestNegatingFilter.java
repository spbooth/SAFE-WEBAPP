...
public class TestNegatingFilter extends WebappTestBase {
	...
	public void testSQLAnd() throws Exception {
		...
		BaseFilter<Dummy1> fred_filter = fac.getSQLAndFilter(fac.new StringFilter("fred"),fac.new NumberFilter(1));
		...
		BaseFilter<Dummy1> no_filter = fac.getSQLAndFilter(fac.new StringFilter("fred"),fac.new NumberFilter(2));
	...
	public void testAnd() throws Exception {
		...
		BaseFilter<Dummy1> fred_filter = fac.getAndFilter(fac.new StringFilter("fred"),fac.new NumberFilter(1));
	...
	public void testAndMixed() throws Exception {
		...
		BaseFilter<Dummy1> fred_filter = fac.getAndFilter(fac.new StringFilter("fred"),fac.new NumberAcceptFilter(1));
	...
	public void testOr() throws Exception {
		...
		OrFilter<Dummy1> fred_filter = fac.getOrFilter();
	...
	public void testJoin() throws Exception {
		...
		SQLOrFilter<DummyReference> fred_filter = ref.getSQLOrFilter();
